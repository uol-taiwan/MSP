...
function recommendation() {
  ...
  const unselected = document.getElementById("all_modules").outerText.split("\n");
  // level 4 modules unselected
  const level4Unselected = document.querySelectorAll("div#all_modules > div.level-4");
  // level 5 modules unselected
  const level5Unselected = document.querySelectorAll("div#all_modules > div.level-5");
  // level 6 modules unselected
  const level6Unselected = document.querySelectorAll("div#all_modules > div.level-6");

  // level 4 modules in credit-modules (array)
  const level4Credit = document.querySelectorAll("div#credit-modules > div.level-4");
  // level 5 modules in credit-modules (array)
  const level5Credit = document.querySelectorAll("div#credit-modules > div.level-5");
  // level 6 modules in credit-modules (array)
  const level6Credit = document.querySelectorAll("div#credit-modules > div.level-6");

  // level 4 modules in attempt-modules (array)
  const level4Attempt = document.querySelectorAll("div#attempt-modules > div.level-4");
  // level 5 modules in attempt-modules (array)
  const level5Attempt = document.querySelectorAll("div#attempt-modules > div.level-5");
  // level 6 modules in attempt-modules (array)
  const level6Attempt = document.querySelectorAll("div#attempt-modules > div.level-6");

  // level 4 modules in planning-modules (array)
  const level4Plan = document.querySelectorAll("div#planning-modules > div.level-4");
  // level 5 modules in planning-modules (array)
  const level5Plan = document.querySelectorAll("div#planning-modules > div.level-5");
  // level 6 modules in planning-modules (array)
  const level6Plan = document.querySelectorAll("div#planning-modules > div.level-6");
  ...
  function level4to5test() {
    if (
      ...
      (level4Attempt.length > 1 ||
        level4Credit.length == 8) &&
  ...
  else if (level6Plan.length !== 0 && !selectPlanning.includes("CM3070: Final Project")) {
    level5to6test();
  }
  ...
  // User picked Final Project
    ...
    suggestion.innerHTML =
      "You did not select any modules to take next term.";
  }
}
